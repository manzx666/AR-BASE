...
const { escapeRegExp } = require("./function.js");
...
async function serialize(client, msg, store) {
  const m = {};
...
module.exports = { Client, getContentType, serialize };
